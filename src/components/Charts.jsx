                        ...
                        <div className='w-[100%] '>
                            <ul role='list' className='py-8 space-y-5'>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Deliver great service experiences fast</span>
                                </li>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Development workflow</span>
                                </li>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Knowledge management</span>
                                </li>
                    ...
                    <div className='w-[100%] h-[100%] lg:w-[50%] flex flex-col justify-center items-start'>
                        ...
                        <div className='w-[100%] '>
                            <ul role='list' className='py-8 space-y-5'>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Dynamic reports and dashboards</span>
                                </li>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Templates for everyone</span>
                                </li>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Development workflow</span>
                                ...
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Limitless business automation</span>
                                </li>
                                <li className='flex items-center space-x-2'>
                                    <svg class=" w-5 h-5 text-purple-500 " fill="#9162f9" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                    <span className='font-medium text-[#000000]'>Knowledge management</span>
